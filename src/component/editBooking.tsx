  ...
  */
  ...
  return (
    <section className="booking-movie-section">
      ...
      <h2 className="booking-movie-section__headline">Ticket bearbeiten</h2>
      ...
      <div className="booking-movie-section__booking-form">
        ...
        <div className="booking-movie-section__snacks-and-drinks">
          ...
          <div className="booking-movie-section__action-buttons">
            <button
              onClick={resetBooking}
              disabled={!(booking.seats.length > 0 && booking.payment !== "")}
              className={`booking-movie-section__reset-button button ${booking.seats.length > 0 && booking.payment !== "" ? "accent-button2 hover" : "disable-button no-hover"}`}
            >
              ...
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                className="booking-movie-section__reset-icon"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
