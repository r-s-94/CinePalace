  ...
  */
  ...
  return (
    <section className="booking-movie-section">
      ...
      <div className="booking-movie-section__headline-container">
        <p className="booking-movie-section__title">{currentMovie.title}</p>
        <p className="booking-movie-section__hall">Saal: {currentMovie.hall}</p>
      </div>
            ...
            <div className="booking-movie-section__abo-snack-package">
              {snackPackage.map((snack) => (
                <div
                  ...
                  className={`booking-movie-section__snack-cart hover ${
      ...
      <div className="booking-movie-section__booking-overview">
        <div className="booking-movie-section__headlines">
          <div className="booking-movie-section__overview-headline">Film</div>
          ...
          <div className="booking-movie-section__overview-headline">Betrag</div>
        </div>
              ...
              <details className="booking-movie-section__detail hover">
                {booking.seats.map((seat) => (
                  <div className="booking-movie-section__seat-info">
                    ...
                    <p className="booking-movie-section__price">
                      Preis:{" "}
                ...
                <details className="booking-movie-section__detail hover">
                  {booking.snackPackage.map((snack) => (
                    <div className="booking-movie-section__snack-package">
                      <p className="booking-movie-section__snack-package-title">
                        {snack.title}
                      </p>
                      <p className="booking-movie-section__price">
                        {" "}
                ...
                <details className="booking-movie-section__detail hover">
                  {booking.singleSnack.map((snack) => (
                    <div className="booking-movie-section__single-snack">
                      ...
                      <p className="booking-movie-section__single-snack-price booking-movie-section__price">
                        Gesamtpreis:{" "}
      ...
      <button
        ...
        className={`booking-movie-section__buy-ticket-button ${booking.seats.length > 0 && booking.payment !== "" ? "primary-button hover" : "disable-button no-hover"}`}
      >
        Ticket kaufen
        <svg
          xmlns="http://www.w3.org/2000/svg"
