        ...
        <div className="booking-overview-section__booking-overview">
          ...
          {bookings.map((movie) => (
            <div className="booking-overview-section__infos">
              ...
              <div className="booking-overview-section__seats">
                {movie.seats.length > 1 ? (
                  <details className="booking-overview-section__detail hover">
                    {movie.seats.map((seat) => (
                      <div className="booking-overview-section__seat-info">
                        <p className="booking-overview-section__hall">
                          Saal: {seat.hall}
                        </p>
                        <p className="booking-overview-section__row">
                          Reihe: {seat.row}
                        </p>
                        <p className="booking-overview-section__seat">
                          Platz: {seat.seat}
                          {"  "}
                          {seat.seat2 !== 0 ? "& " : null}
                          {seat.seat2 !== 0 ? seat.seat2 : ""}
                        </p>
                        <p className="booking-overview-section__price">
                          Preis:{" "}
                  ...
                  <div className="booking-overview-section__seat-info">
                    <p className="booking-overview-section__hall-info">
                      Saal:{" "}
              ...
              <div className="booking-overview-section__snacks-and-drinks-overview">
                {movie.snackPackage.length > 1 ? (
                  <div className="booking-overview-section__snack-packages-overview">
                    <p className="booking-overview-section__snack-packages-headline">
                      Snack-Packete
                    </p>
                    <details className="booking-overview-section__detail hover">
                      {movie.snackPackage.map((snack) => (
                        <div className="booking-overview-section__snack-package">
                          <p className="booking-overview-section__title">
                            {snack.title}
                          </p>
                          <p className="booking-overview-section__price">
                            {" "}
                  ...
                  <div className="booking-overview-section__snack-package-overview">
                    <p className="booking-overview-section__snack-package-headline">
                      Snack-Packet
                    </p>
                    <div className="booking-overview-section__snack-package">
                      <p className="booking-overview-section__title">
                        {movie.snackPackage[0].title}
                      </p>
                      <p className="booking-overview-section__price">
                ...
                {movie.singleSnack.length > 1 ? (
                  <div className="booking-overview-section__single-snacks-overview">
                    <p className="booking-overview-section__single-snacks-headline">
                      Single-Snacks
                    </p>
                    <details className="booking-overview-section__detail hover">
                      {movie.singleSnack.map((snack) => (
                        <div className="booking-overview-section__single-snack">
                          <p className="booking-overview-section__single-snack-title">
                            {snack.title}
                          </p>
                          <p className="booking-overview-section__size">
                          ...
                          <p className="booking-overview-section__single-snack-price">
                            Gesamtpreis:{" "}
                            {Number(
                  ...
                  <div className="booking-overview-section__single-snack-overview">
                    <p className="booking-overview-section__single-snack-headline">
                      Single-Snack
                    </p>
                    <div className="booking-overview-section__single-snack">
                      <p className="booking-overview-section__single-snack-title">
              ...
              <div className="booking-overview-section__info-payment">
                {movie.payment}
              </div>
              <div className="booking-overview-section__calculate">
              ...
              <div className="booking-overview-section__buttons">
                <button
                  ...
                  className="booking-overview-section__edit-button secondary-button hover"
                >
                  Buchung bearbeiten
                  <svg
                ...
                <button
                  ...
                  className="booking-overview-section__delete-button delete-button hover"
                >
                  Buchung löschen{" "}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
