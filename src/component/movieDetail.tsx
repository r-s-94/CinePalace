...
export default function MovieDetail() {
  ...
  return (
    <section className="movie-detail-section">
      ...
      <div className="movie-detail-section__info-main-container">
        <div className="movie-detail-section__slider-main-container">
          <button
            onClick={() => {
              moveSlider(-1);
            }}
            className="movie-detail-section__prev-button button secondary-button"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <button
            ...
            className="movie-detail-section__next-button button secondary-button"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        <div className="movie-detail-section__info-container">
          <h2 className="movie-detail-section__headline">
            {currentMovie.title}
          </h2>
          ...
          <p className="movie-detail-section__hall">
          ...
          <button
            ...
            className="movie-detail-section__buy-ticket-button button primary-button"
          >
            Ticket buchen
            <svg
              xmlns="http://www.w3.org/2000/svg"
